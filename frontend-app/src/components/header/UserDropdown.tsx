...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="flex items-center justify-center mr-3 overflow-hidden rounded-full h-11 w-11 bg-brand-100 dark:bg-brand-900 text-brand-600 dark:text-brand-300 font-semibold text-lg">
