...
export default function Profile() {
  ...
  const handleChangePassword = () => {
    ...
    window.open(passwordUrl, "_blank", "noopener,noreferrer");
  };

  if (!user) {
    return (
      <>
        <PageMeta title="Profile | ZenAndOps" description="View your profile" />
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-gray-200 p-5 dark:border-gray-800 lg:p-6">
            <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
              <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
                <div className="flex h-20 w-20 items-center justify-center overflow-hidden rounded-full border border-gray-200 bg-brand-100 dark:border-gray-800 dark:bg-brand-900">
            ...
            <div className="flex flex-wrap gap-2">
              {user.tags.length > 0 ? (
                user.tags.map((tag, index) => (
                  <Badge key={index} variant="light" size="sm" color="info">
                    {tag.key}:{tag.value}
                  </Badge>
                ))
              ) : (
          ...
          <div className="rounded-2xl border border-gray-200 p-5 dark:border-gray-800 lg:p-6">
            ...
            <p className="mb-4 text-sm text-gray-500 dark:text-gray-400">
              Profile editing and password changes are managed through the identity provider.
            </p>
