...
/**
 * MongoDB Panache entity mapping for the AssetVersion domain entity.
 */
@MongoEntity(collection = "asset_versions", database = "zenandops-cmdb")
public class AssetVersionPanacheEntity extends PanacheMongoEntity {
